...
Strategy: `live_http_siglip2_rerank_targeted1`
Dataset: `shop_1774155549_live_http_targeted1`
...
Top-1 exact matches: 90 / 106 (84.91%)
...
| --- | --- | --- | --- | --- |
| clean_web | 54 | 83.33% | 100.00% | 0.9136 |
| discord_noise | 52 | 86.54% | 98.08% | 0.9279 |

## Top-1 Misses

- [discord_noise] 勾n zoom阿尔法跑步鞋(多色合集) / `` -> expected `916`, predicted `922` (勾k SB板鞋(多色合集), 1.0509)
- [clean_web] 勾n HotStep2气垫运动鞋(基础色合集) / `` -> expected `918`, predicted `931` (勾n VapormaxFlyknit气垫鞋, 1.0197)
- [clean_web] 勾n HotStep2气垫运动鞋(基础色合集) / `` -> expected `918`, predicted `931` (勾n VapormaxFlyknit气垫鞋, 0.9866)
...
- [clean_web] 勾1 UN联名板鞋 / `` -> expected `924`, predicted `922` (勾k SB板鞋(多色合集), 1.0429)
...
- [discord_noise] 勾af 联名OFF休闲防滑板鞋(多色合集) / `` -> expected `926`, predicted `922` (勾k SB板鞋(多色合集), 1.0429)
- [discord_noise] 勾dg 板鞋(三色合集) / `` -> expected `927`, predicted `922` (勾k SB板鞋(多色合集), 1.0429)
- [clean_web] 勾dg 板鞋(多色/品牌联名合集) / `` -> expected `930`, predicted `927` (勾dg 板鞋(三色合集), 1.0049)
- [discord_noise] 勾n VapormaxFlyknit气垫鞋 / `` -> expected `931`, predicted `932` (勾n Max90气垫运动鞋(多色合集), 1.0008)
