...
Strategy: `live_http_siglip2_rerank_targetedcluster2_directional`
Dataset: `shop_1774155549_live_http_targetedcluster2_directional`
...
| discord_noise | 52 | 86.54% | 98.08% | 0.9247 |
...
- [clean_web] 勾dg 联名DunkSB低帮板鞋 / `` -> expected `925`, predicted `933` (勾1 粉色板鞋, 0.9762)
