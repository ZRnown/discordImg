...
Strategy: `live_http_siglip2_rerank_targetedpair1`
Dataset: `shop_1774155549_live_http_targetedpair1`
...
| --- | --- | --- | --- | --- |
| clean_web | 54 | 87.04% | 100.00% | 0.9321 |
| discord_noise | 52 | 84.62% | 98.08% | 0.9173 |
...
- [discord_noise] 勾dg 板鞋(三色合集) / `` -> expected `927`, predicted `923` (勾n shoxRide2运动鞋(四色合集), 1.0000)
