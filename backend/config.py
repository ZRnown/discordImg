...
class Config:
    ...
    LIVE_IMAGE_SEARCH_STREAMING_FORCE = _env_bool('LIVE_IMAGE_SEARCH_STREAMING_FORCE', True)
    LIVE_IMAGE_SEARCH_MAX_INFLIGHT = _env_int('LIVE_IMAGE_SEARCH_MAX_INFLIGHT', 4)
    LIVE_IMAGE_SEARCH_QUEUE_TIMEOUT_SECONDS = _env_float('LIVE_IMAGE_SEARCH_QUEUE_TIMEOUT_SECONDS', 10.0)
