...
class Config:
    ...
    LIVE_IMAGE_SEARCH_STRATEGY = os.getenv('LIVE_IMAGE_SEARCH_STRATEGY', 'current_dino_hybrid')
    ...
    DISCORD_SEND_TIMEOUT_SECONDS = _env_float('DISCORD_SEND_TIMEOUT_SECONDS', 20.0)
    DISCORD_SEND_SHARED_LOCK_PATH = os.getenv('DISCORD_SEND_SHARED_LOCK_PATH', '')
    DISCORD_MAX_RATELIMIT_TIMEOUT = _env_float('DISCORD_MAX_RATELIMIT_TIMEOUT', 30.0)
    DISCORD_SEND_TYPING_ENABLED = _env_bool('DISCORD_SEND_TYPING_ENABLED', False)
    DISCORD_BOUND_CHANNEL_CACHE_TTL_SECONDS = _env_float('DISCORD_BOUND_CHANNEL_CACHE_TTL_SECONDS', 60.0)
    DISCORD_DISCONNECT_OFFLINE_GRACE_SECONDS = _env_float('DISCORD_DISCONNECT_OFFLINE_GRACE_SECONDS', 45.0)
    DISCORD_GATEWAY_FLAP_WINDOW_SECONDS = _env_float('DISCORD_GATEWAY_FLAP_WINDOW_SECONDS', 600.0)
    DISCORD_GATEWAY_FLAP_THRESHOLD = _env_int('DISCORD_GATEWAY_FLAP_THRESHOLD', 5)
    ...
    DISCORD_IMAGE_RECOGNITION_MAX_INFLIGHT = _env_int(
        'DISCORD_IMAGE_RECOGNITION_MAX_INFLIGHT',
        2,
    )
    DISCORD_IMAGE_RECOGNITION_MAX_ATTEMPTS = _env_int(
        'DISCORD_IMAGE_RECOGNITION_MAX_ATTEMPTS',
        1,
    )
    DISCORD_IMAGE_RECOGNITION_RETRY_DELAY_SECONDS = _env_float(
        'DISCORD_IMAGE_RECOGNITION_RETRY_DELAY_SECONDS',
        1.0,
    )
